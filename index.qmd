...
**NOTE: Results are final for Week `r as.numeric(readr::read_lines("dat/update_week.txt"))`, but Sleeper does not like to share scores for teams not in champion or toilet bracket matchups. Eliminator tables updated by hand herein, other tables on this site may contain inaccuracies.**
:::
